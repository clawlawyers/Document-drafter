        ...
        <div className="flex flex-row w-full p-5 space-x-5 bg-customBlack rounded-md h-full justify-center items-start">
          <div className="flex flex-col w-[70%] h-full space-y-5">
            ...
            <div className="flex flex-row justify-end items-center gap-5">
              ...
              <button onClick={handleSave} className="p-2 rounded-md px-10 border-2 border-teal-700">
                Save
              </button>
            </div>
          </div>

          <div className="w-[30%] h-full overflow-hidden "> {/* Fixed width and overflow hidden */}
            <AnimatePresence mode="wait">
              {activeSidebar === "edit" ? (
                <motion.div
                  ...
                  className=" bg-transparent rounded-md w-full h-full " // Ensure full width
                >
                  <EditSidebar />
                </motion.div>
              ) : (
                <motion.div
                  ...
                  exit={{ x: -300, opacity: 0 }}
                  transition={{ duration: 0.5 }}
                  className="p-4 bg-transparent rounded-md w-full" // Ensure full width
                >
