...
import { Dialog, DialogActions, DialogContent, Typography, TextField, Box } from "@mui/material";
...
const ResponseDialog = ({ open, onClose, responseText, onSave }) => {
  ...
  return (
    <Dialog open={open} onClose={onClose} className="backdrop-blur-sm" fullWidth maxWidth="md">
        ...
        <DialogContent className="flex p-0 h-[90vh]">
          ...
          <Box className="flex-1 flex flex-col items-center justify-between p-4 h-full">
            <div className="w-full flex flex-row gap-2 items-center justify-center">
              <Typography variant="h3" className="font-bold text-teal-500">Adira AI</Typography>
